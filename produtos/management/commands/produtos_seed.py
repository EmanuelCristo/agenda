...
class Command(BaseCommand):
    help = 'Seed customizado para gerar dados para especificados produtos'
    ...
    def handle(self, *args, **kwargs):
        ...
        seeder.add_entity(Produto, 94, {
            ...
            'preco': lambda x: random.uniform(0.01, 100),
        ...
        self.stdout.write(self.style.SUCCESS(f'Instâncias de Produtos adicionados'))